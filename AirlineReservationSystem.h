...
private: // YOU MAY ADD YOUR OWN UTILITY MEMBER FUNCTIONS HERE.
    void HELPERsearchFlight(const std::string &departureCity, const std::string &arrivalCity, std::vector<Flight *> &result, BSTNode<Flight> *root);
    Passenger *HELPERsearchPassenger(const std::string &firstname, const std::string &lastname, BSTNode<Passenger> *root);
    BSTNode<Flight> *FindFlightWithCode(const std::string &flightCode, BSTNode<Flight> *root) const;
